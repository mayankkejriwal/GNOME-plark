...
def _get_sanity_neighbors():
    top2neighbors = {
        ...
        "0201A": {'0302A', '0102A', '0301A', '0202A', '0101A', 'escape'},
        "0301A": {'0302A', '0401A', 'escape', '0201A'},
        "0401A": {'0501A', '0302A', '0502A', '0301A', '0402A', 'escape'},
        "0501A": {'0401A', '0601A', 'escape', '0502A'},
        "0601A": {'0501A', '0602A', '0502A', '0701A', '0702A', 'escape'},
        "0701A": {'0702A', '0801A', 'escape', '0601A'},
        "0801A": {'0701A', '0902A', '0901A', '0702A', '0802A', 'escape'},
        "0901A": {'escape', '0801A', '0902A', '1001A'},
        "1001A": {'0902A', '1002A', '0901A', '0102B', '0101A', 'escape'},
        "0101B": {'0102B', 'escape', '1001A', '0201B'},
        "0201B": {'0302B', '0301B', '0102B', '0202B', '0101B', 'escape'},
        "0301B": {'0401B', '0201B', 'escape', '0302B'},
        "0401B": {'0301B', '0402B', '0501B', '0502B', '0302B', 'escape'},
        "0501B": {'0401B', '0601B', 'escape', '0502B'},
        "0601B": {'0501B', '0502B', '0702B', '0602B', '0701B', 'escape'},
        "0701B": {'0801B', '0601B', '0702B', 'escape'},
        "0801B": {'0702B', '0901B', '0701B', '0802B', '0902B', 'escape'},
        "0901B": {'0902B', '1001B', 'escape', '0801B'},
        "1001B": {'0102C', '1002B', '0902B', '0901B', '0101C', 'escape'},
        "0101C": {'0102C', 'escape', '1001B', '0201C'},
        "0201C": {'0102C', '0202C', '0301C', '0302C', '0101C', 'escape'},
        "0301C": {'0302C', '0201C', 'escape', '0401C'},
        "0401C": {'0302C', '0402C', '0502C', '0501C', '0301C', 'escape'},
        "0501C": {'escape', '0401C', '0502C', '0601C'},
        "0601C": {'0702C', '0502C', '0501C', '0602C', '0701C', 'escape'},
        "0701C": {'0702C', '0801C', 'escape', '0601C'},
        "0801C": {'0702C', '0901C', '0701C', '0802C', '0902C', 'escape'},
        "0901C": {'1001C', '0801C', 'escape', '0902C'},
        "1001C": {'0901C', '0902C', '1002C', 'escape'},
    ...
    right2neighbors = {
        "1001A": {'0901A', '0902A', '0102B', '1002A', 'escape', '0101B'},
        ...
        "1001B": {'0902B', '0901B', '1002B', '0102C', 'escape', '0101C'},
        ...
        "1001C": {'1002C', '0901C', '0902C', 'escape'},
